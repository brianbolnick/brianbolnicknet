...
import MenuIcon from '../../img/menu-icon-black.png';
import '../../css/App.css';
import '../../css/Home.css';
        ...
        return (
            this.isLoggedIn()
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <Button as={Link} to='/' basic inverted color='green' style={{marginRight: '5px'}}>
                        <Icon name='home' />
                        Home
                    </Button>
                    <Button.Group>
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <Divider hidden />                 
                    <Button as={Link} to='/' basic inverted style={{marginRight: '5px'}}>
                        <Icon name='home' />
                        Home
                    </Button>
                </div>
...
class ModalMenu extends Component {
    render() {
        return (
            <Modal dimmer='blurring' basic trigger={<Image src={MenuIcon} className='showcase-menu-button' size='mini' as='a' href="#" />} closeIcon>
